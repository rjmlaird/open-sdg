<h1>Upgrading to 2.4.0-beta1</h1>
...
## Update version of Open SDG to 2.4.0-beta1

In your site repository's `_config.yml` file, update the version of Open SDG in `remote_theme`, like so:

```
remote_theme: open-sdg/open-sdg@2.4.0-beta1
```

## Update version of jekyll-open-sdg-plugins to 2.4.0-beta1

In your site repository's `Gemfile`, update the version of jekyll-open-sdg-plugins like so:

```
gem "jekyll-open-sdg-plugins", "2.4.0.pre.beta1"
```
